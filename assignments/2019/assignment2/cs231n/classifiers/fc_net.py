...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        X2,fc_relu_cache2 = affine_relu_forward(X, W1, b1)
        scores, fc_relu_cache = affine_relu_forward(X2, W2, b2)
        ...
        dX2, dW2, db2 = affine_relu_backward(dscores, fc_relu_cache)
        dX1, dW1, db1 = affine_relu_backward(dX2, fc_relu_cache2)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for h in range(hidden_layer_count - 1, -1, -1):
            ...
            grads['b' + str(h+1)] = db
            if self.normalization != None:
                grads['gamma' + str(h+1)] = dgamma
                grads['beta' + str(h+1)] = dbeta
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
